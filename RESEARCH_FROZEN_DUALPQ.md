...
## 5. Mean ± SD
**Frozen-DASNet DualPQ:** 74.46% ± 0.97% (Med: 74.77%, Min: 72.55%, Max: 75.23%, 95%CI: [73.61%, 75.31%])

## 6. Per-SNR results
| Model | Clean | 40dB | 30dB | 20dB | 10dB | 0dB | Overall |
|---|---|---|---|---|---|---|---|
| **Frozen DualPQ** | 91.2±1.3 | 91.7±0.9 | 89.6±0.8 | 82.4±0.9 | 62.4±1.3 | 27.0±2.4 | 74.46 |
...
**Original DualPQ-D:** 61.63% ± 13.94%
**Frozen-DASNet DualPQ:** 74.46% ± 0.97%

## 8. Whether variance decreased
The standard deviation went from **±13.94%** to **±0.97%**.
Variance was massively reduced, completely eliminating the catastrophic optimization collapses seen in Seeds 2 and 3 of the original run.
